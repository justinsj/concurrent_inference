...
def main(loop_duration_s, output_path, net_iface, gpu_index):
...
if __name__ == '__main__':       
    ...
    parser.add_argument('output_path', type=str, help='Save logs to destination csv path')
    ...
    main(args.loop_duration_s, args.output_path, args.net_iface, args.gpu_index)
